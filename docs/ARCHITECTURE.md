...
| À quoi ressemble le feu ? | `fx/fire.gd` **et lui seul** — les langues d'Immolation et de la Ruée ardente, les braises d'Ignition, la traînée de la Boule de feu, son explosion et le dos du Serpent infernal. Une langue est **un profil qui se renfle** (30 % de sa hauteur) et trois couches emboîtées : halo teinté, corps tiède, cœur presque blanc. L'orange du feu plafonne à **0,57 de luminance**, donc seul `Fire.heart()` (0,92) dépasse le seuil de glow — et il reste une mèche, parce qu'en additif les couches s'ajoutent et que **c'est le bleu du blanc chaud qui blanchit** un effet avant qu'il ait l'air chaud. `Fire.breath()` donne la même respiration à tout ce qui brûle |
| À quoi ressemble la glace ? | `fx/frost.gd` **et lui seul** — les pics de Pics de glace, les bras et les éclats du Désastre hivernal, les pans du Tombeau de glace et les esquilles de la Nova de glace. Un cristal est **deux flancs et une arête** : la même teinte à deux opacités (0,34 et 0,62) et le givre entre les deux. **Le froid ne se blanchit pas, il s'ombre** — son cyan porte déjà 0,81 de luminance, la matière la plus claire du jeu, et déborde à pleine opacité sans qu'on y ajoute rien ; l'éclaircir lui retire sa teinte. En additif, ombrer veut dire retirer de l'alpha, jamais de la couleur |
